...
import SendMessage from '../components/local/utils/Messages/SendMessage'
import CourseCard from '../components/local/category/CourseCard'
                        ...
                        {navigation === 0 ? <div className={styles.personalData}>
                            ...
                            <form className={styles.form}>
                                <fieldset disabled={disabled}>
                                    ...
                                    <input type="text" value={"Хз"} placeholder='Отчество' />
                                    <input type="text" onChange={(t) => {
                                        setEmail(t.target.value)
                                    }} value={email} placeholder='Email' />
                                    <input type="text" onChange={(t) => {
                                        setSelectSex(t.target.value)
                                    }} value={selectSex} placeholder='Пол' />
                                    <input type="text" value={"23.10.2006"} placeholder='Дата рождения' />
                                    <input type="text" onChange={(t) => {
                                        setPhoneNumber(t.target.value)
                                    }} value={phoneNumber} placeholder='Номер телефона' />
                                    <input type="text" value={"Ташкент"} placeholder='Регион' />
                                </fieldset>
                            </form>
                            ...
                            <div className={styles.balance}>
                                ...
                                <div className={styles.inCash}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                        <path d="M8.52637 9.66711L14.0001 9.66711" stroke="#29CB73" stroke-width="2" stroke-linecap="round" />
                                    ...
                                    return <div key={i} className={styles.transaction}>
                                        ...
                                        <div className={styles.date}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19" fill="none">
                                                <path d="M1 9.03829C1 5.84744 1 4.25159 1.92086 3.26074C2.84093 2.26904 4.3228 2.26904 7.28573 2.26904H10.4286C13.3915 2.26904 14.8734 2.26904 15.7935 3.26074C16.7143 4.25159 16.7143 5.84744 16.7143 9.03829V10.7306C16.7143 13.9215 16.7143 15.5173 15.7935 16.5082C14.8734 17.4999 13.3915 17.4999 10.4286 17.4999H7.28573C4.3228 17.4999 2.84093 17.4999 1.92086 16.5082C1 15.5173 1 13.9215 1 10.7306V9.03829Z" stroke="#9A9A9A" stroke-width="1.5" />
                                                <path d="M4.9283 2.26923V1M12.7855 2.26923V1M1.39258 6.50002H16.3212" stroke="#9A9A9A" stroke-width="1.5" stroke-linecap="round" />
